...
function CheckoutPage() {
  ...
  return (
    <section className="mx-auto w-full max-w-6xl">
      <div className="grid items-start gap-5 md:gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(300px,1fr)]">
        <form onSubmit={placeOrder} className="space-y-4 rounded-2xl border border-slate-200 bg-white p-5 sm:p-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-slate-900 px-5 py-3 font-semibold text-white transition hover:bg-slate-700 disabled:opacity-70 sm:w-auto"
          >
